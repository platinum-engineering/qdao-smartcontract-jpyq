const JPYQToken = artifacts.require("./JPYQToken/JPYQToken.sol");
...
module.exports = function(deployer) {
    deployer.then(async () => {
        ...
        await wait(await deployer.deploy(JPYQToken, firstAddress, secondAddress, thirdAddress, fourthAddress, fifthAddress));
    });
};
